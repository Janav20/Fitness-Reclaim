...
<body onload="myFunction()" style="margin:0;">
  ...
  <div class="container tej-von">
    ...
    <p class="para-tej tej-text-lg">With the right plan and the right discipline, you can get seriously shredded in just
      28 days.
    </p>
    <div class="info container">
      <div class="carbo" id="carbohy">
        ...
        <div class="car-info">
          Eating a well-balanced diet can help you get the calories and nutrients you need to fuel your daily
          activities, including regular exercise.

          When it comes to eating foods to fuel your exercise performance, it’s not as simple as choosing vegetables
