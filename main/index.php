...
<body onload="myFunction()" style="margin:0;">
  ...
  <div class="personal" id="Personal-id">
    ...
    <div class="card mb-3 tej-card" style="max-width: 540px;">
      <div class="row g-0">
        <div class="col-md-4">
          <img src="Pictures/me.jpg" class="img-fluid rounded-start" alt="..." style="height:100%;">
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Janav Shetty</h5>
            <p class="card-text"> A certified fitness expert with 5 years of experience. Specializing in strength
              training, weight loss, and personalized programs, He is dedicated to helping you achieve your fitness
              goals.</p>
