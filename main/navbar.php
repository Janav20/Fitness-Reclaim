  ...
  <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
    ...
    <div class="form-inline my-2 my-lg-0 tej-div">
      ...
      <a href="Pricing.php" class="tej-flex tej-1 " target="_blank">
        <button id="SignUp" class="btn btn-outline-warning my-2 my-sm-0 tej-black" type="submit"><i
            class="fa-solid fa-crown"></i>Subscription</button>
      </a>
      <?php
      if (isset($_SESSION['username'])) {
        ?>
...
<div id="incident">
  <div class="incident">
    ...
    <p>Reclaim Fitness is your ultimate destination for transforming body and mind. With state-of-the-art equipment,
      expert trainers, and personalized programs, we’re dedicated to helping you reclaim your health, strength, and
      confidence. Start your fitness journey with us today!</p>
