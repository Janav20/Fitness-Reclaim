            ...
            <div id="pro-sect-1">
                <div class="profile-info" id="pro-about">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" class="d-flex flex-column flex-wrap">
                        ...
                        <button class="upload-btn btn btn-outline-success m-2" type="submit" name="upload_photo">Upload
                            Photo</button>
                    </form>
                ...
                <div class="profile-section" id="pro-info">
                    ...
                    <form action="" method="post">
                        ...
                        <input type="text" id="training-experience" value="<?php echo $TrainingExp; ?>+ Years"
                            name="exp" readonly>
